...
var _dirtyjson = require('dirty-json'); var _dirtyjson2 = _interopRequireDefault(_dirtyjson);
...
function fillLocateParam(locate) {
  if (_optionalChain([locate, 'optionalAccess', _ => _.bbox_2d]) && !_optionalChain([locate, 'optionalAccess', _2 => _2.bbox])) {
    locate.bbox = locate.bbox_2d;
    delete locate.bbox_2d;
  }
  const defaultBboxSize = 10;
  if (_optionalChain([locate, 'optionalAccess', _3 => _3.bbox])) {
...
function warnGPT4oSizeLimit(size) {
  if (warned)
    return;
  if (_optionalChain([getModelName, 'call', _4 => _4(), 'optionalAccess', _5 => _5.toLowerCase, 'call', _6 => _6(), 'access', _7 => _7.includes, 'call', _8 => _8("gpt-4o")])) {
...
function systemPromptToLocateElement() {
  if (_chunkDWFHUOJEjs.getAIConfigInBoolean.call(void 0, _chunkDWFHUOJEjs.MATCH_BY_POSITION)) {
    return `
## Role:
...
function elementByPositionWithElementInfo(treeRoot, position) {
  ...
  function dfs(node) {
    if (_optionalChain([node, 'optionalAccess', _9 => _9.node])) {
...
async function describeUserPage(context, opt) {
  ...
  const contentTree = await _extractor.descriptionOfTree.call(void 0, 
    treeRoot,
    _optionalChain([opt, 'optionalAccess', _10 => _10.truncateTextLength]),
    _optionalChain([opt, 'optionalAccess', _11 => _11.filterNonTextContent])
  );
  const pageJSONDescription = _chunkDWFHUOJEjs.getAIConfigInBoolean.call(void 0, _chunkDWFHUOJEjs.MATCH_BY_POSITION) ? "" : `Some of the elements are marked with a rectangle in the screenshot, some are not. 
...
${contentTree}`;
 ...
 ${pageJSONDescription}`,
    elementById(id) {
      _utils.assert.call(void 0, typeof id !== "undefined", "id is required for query");
...
async function systemPromptToTaskPlanning() {
  if (_chunkDWFHUOJEjs.getAIConfigInBoolean.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_USE_QWEN_VL)) {
...
function checkAIConfig() {
  if (_chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.OPENAI_API_KEY))
    return true;
  if (_chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_USE_AZURE_OPENAI))
    return true;
  if (_chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.ANTHROPIC_API_KEY))
    return true;
  return Boolean(_chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_OPENAI_INIT_CONFIG_JSON));
}
var debugProfile = _utils.getDebug.call(void 0, "ai:profile");
var debugResponse = _utils.getDebug.call(void 0, "ai:response");
var shouldPrintTiming = _chunkDWFHUOJEjs.getAIConfigInBoolean.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_DEBUG_AI_PROFILE);
var debugConfig = "";
...
var shouldPrintAIResponse = _chunkDWFHUOJEjs.getAIConfigInBoolean.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_DEBUG_AI_RESPONSE);
...
if (debugConfig) {
  _utils.enableDebug.call(void 0, debugConfig);
}
var defaultModel = "gpt-4o";
function getModelName() {
  let modelName = defaultModel;
  const nameInConfig = _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_MODEL_NAME);
  if (nameInConfig) {
...
async function createChatClient({
  ...
  const socksProxy = _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_OPENAI_SOCKS_PROXY);
  const socksAgent = socksProxy ? new (0, _socksproxyagent.SocksProxyAgent)(socksProxy) : void 0;
  if (_chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.OPENAI_USE_AZURE)) {
    openai = new (0, _openai.AzureOpenAI)({
      baseURL: _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.OPENAI_BASE_URL),
      apiKey: _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.OPENAI_API_KEY),
      httpAgent: socksAgent,
      ...extraConfig,
      dangerouslyAllowBrowser: true
    });
  } else if (_chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_USE_AZURE_OPENAI)) {
    const extraAzureConfig = _chunkDWFHUOJEjs.getAIConfigInJson.call(void 0, 
      _chunkDWFHUOJEjs.MIDSCENE_AZURE_OPENAI_INIT_CONFIG_JSON
    );
    const scope = _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_AZURE_OPENAI_SCOPE);
    ...
    if (scope) {
      ...
      openai = new (0, _openai.AzureOpenAI)({
        ...
        endpoint: _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.AZURE_OPENAI_ENDPOINT),
        apiVersion: _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.AZURE_OPENAI_API_VERSION),
        deployment: _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.AZURE_OPENAI_DEPLOYMENT),
        ...extraConfig,
        ...extraAzureConfig
      });
    } else {
      openai = new (0, _openai.AzureOpenAI)({
        apiKey: _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.AZURE_OPENAI_KEY),
        endpoint: _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.AZURE_OPENAI_ENDPOINT),
        apiVersion: _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.AZURE_OPENAI_API_VERSION),
        deployment: _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.AZURE_OPENAI_DEPLOYMENT),
        dangerouslyAllowBrowser: true,
  ...
  } else if (!_chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_USE_ANTHROPIC_SDK)) {
    const baseURL = _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.OPENAI_BASE_URL);
...
Please check your config.`
    ...
    openai = new (0, _openai2.default)({
      ...
      ...extraConfig,
      defaultHeaders: {
        ..._optionalChain([extraConfig, 'optionalAccess', _12 => _12.defaultHeaders]) || {},
        [_chunkDWFHUOJEjs.MIDSCENE_API_TYPE]: AIActionTypeValue.toString()
      },
      dangerouslyAllowBrowser: true
    });
  }
  if (openai && _chunkDWFHUOJEjs.getAIConfigInBoolean.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_LANGSMITH_DEBUG)) {
    if (_utils.ifInBrowser) {
      throw new Error("langsmith is not supported in browser");
    }
    console.log("DEBUGGING MODE: langsmith wrapper enabled");
    const { wrapOpenAI } = await Promise.resolve().then(() => require("langsmith/wrappers"));
  ...
  if (_chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_USE_ANTHROPIC_SDK)) {
    const apiKey = _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.ANTHROPIC_API_KEY);
...
async function call(messages, AIActionTypeValue, responseFormat) {
  ...
  const maxTokens = _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.OPENAI_MAX_TOKENS);
  const startTime = Date.now();
  const model = getModelName();
  let content;
  let usage;
  const commonConfig = {
    temperature: _chunkDWFHUOJEjs.getAIConfigInBoolean.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_USE_VLM_UI_TARS) ? 0 : 0.1,
    stream: false,
    max_tokens: typeof maxTokens === "number" ? maxTokens : Number.parseInt(maxTokens || "2048", 10),
    ..._chunkDWFHUOJEjs.getAIConfigInBoolean.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_USE_QWEN_VL) ? {
  ...
  if (style === "openai") {
    ...
    debugProfile(
      ...
      model,
      _chunkDWFHUOJEjs.getAIConfig.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_USE_QWEN_VL) ? " MIDSCENE_USE_QWEN_VL," : "",
...
function safeParseJson(input) {
  ...
  if (_optionalChain([cleanJsonString, 'optionalAccess', _13 => _13.match, 'call', _14 => _14(/\((\d+),(\d+)\)/)])) {
    return _optionalChain([cleanJsonString, 'access', _15 => _15.match, 'call', _16 => _16(/\((\d+),(\d+)\)/), 'optionalAccess', _17 => _17.slice, 'call', _18 => _18(1), 'access', _19 => _19.map, 'call', _20 => _20(Number)]);
  }
  try {
...
async function AiInspectElement(options) {
  ...
  if (_chunkDWFHUOJEjs.getAIConfigInBoolean.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_USE_QWEN_VL)) {
    imagePayload = await _img.paddingToMatchBlock.call(void 0, imagePayload);
  }
  const msgs = [
...
async function AiAssert(options) {
  ...
  const systemPrompt = systemPromptToAssert({
    isUITars: _chunkDWFHUOJEjs.getAIConfigInBoolean.call(void 0, _chunkDWFHUOJEjs.MIDSCENE_USE_VLM_UI_TARS)
  });
  const msgs = [
    { role: "system", content: systemPrompt },
    {
...
async function plan(userInstruction, opts) {
  ...
  const actions = (_optionalChain([planFromAI, 'access', _21 => _21.action, 'optionalAccess', _22 => _22.type]) ? [planFromAI.action] : planFromAI.actions) || [];
  const returnValue = {
    ...planFromAI,
    actions,
    rawResponse,
...
async function vlmPlanning(options) {
  ...
  parsed.forEach((action) => {
    if (action.action_type === "click") {
      _utils.assert.call(void 0, action.action_inputs.start_box, "start_box is required");
      ...
      _utils.assert.call(void 0, action.action_inputs.start_box, "start_box is required");
      _utils.assert.call(void 0, action.action_inputs.end_box, "end_box is required");
      ...
      _utils.assert.call(void 0, action.action_inputs.key, "key is required");

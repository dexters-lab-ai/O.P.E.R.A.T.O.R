...
var debug = (0, import_utils4.getDebug)("cache");
var TaskCache = class {
  constructor(opts) {
  ...
  readCacheFromFile() {
    ...
    if (!(0, import_env.getAIConfigInBoolean)("MIDSCENE_CACHE")) {
      return void 0;
    }
...
var import_utils7 = require("@midscene/shared/utils");
var debug2 = (0, import_utils7.getDebug)("plan-builder");
function buildPlans(type, locate, param) {
  ...
  if (type === "Tap" || type === "Hover") {
    (0, import_utils7.assert)(locatePlan, `missing locate info for action "${type}"`);
    const tapPlan = {
      type,
      param: null,
      thought: "",
  ...
  if (type === "Input" || type === "KeyboardPress") {
    ...
    (0, import_utils7.assert)(param, `missing param for action "${type}"`);
    const inputPlan = {
      type,
      param,
      thought: "",
...
async function parseContextFromWebPage(page, _opt) {
  (0, import_utils9.assert)(page, "page is required");
  if (page._forceUsePageContext) {
    return await page._forceUsePageContext();
  }
  const url = await page.url();
  (0, import_utils8.uploadTestInfoToServer)({ testUrl: url });
  ...
  (0, import_utils9.assert)(screenshotBase64, "screenshotBase64 is required");
...
var import_utils13 = require("@midscene/core/utils");
...
var debugPage = (0, import_utils14.getDebug)("web:page");
var Page = class {
  ...
  async getElementsNodeTree() {
    ...
    (0, import_utils14.assert)(scripts, "scripts should be set before writing report in browser");
  ...
  async clearInput(element) {
    ...
    await (0, import_utils13.sleep)(100);
...
async function waitForNetworkIdle(page, timeout = 1e4) {
  try {
...
var launcherDebug = (0, import_utils15.getDebug)("puppeteer:launcher");
...
var import_utils16 = require("@midscene/core/utils");
var import_extractor3 = require("@midscene/shared/extractor");
...
var Page2 = class {
  ...
  async getElementsInfo() {
    ...
    const infos = (0, import_extractor3.clientExtractTextWithPosition)(doc).filter(
  ...
  async screenshotBase64() {
    ...
    const path = (0, import_utils16.getTmpFile)("png");
    ...
    import_node_fs4.default.writeFileSync(path, resizedScreenshotBuffer);
    return (0, import_img2.base64Encoded)(path);
  }
  get mouse() {
    return {
      click: (x, y, options) => this.mouseClick(x, y, options?.button || "left"),

    ...
    const task = {
      ...
      executor: async (param, executorContext) => {
        ...
        if (sleep2) {
          ...
          const timeRemaining = sleep2 - (timeNow - shotTime);
          if (timeRemaining > 0) {
            finalActions.push({
              type: "Sleep",
              param: {
...
var Page = class {
  ...
  async getElementsInfo() {
    ...
    const infos = (0, import_extractor2.clientExtractTextWithPosition)(doc).filter(
  ...
  async screenshotBase64() {
    ...
    const path = (0, import_utils13.getTmpFile)("png");
    ...
    import_node_fs3.default.writeFileSync(path, resizedScreenshotBuffer);

...
async function launchPuppeteerPage(target, preference) {
  (0, import_utils15.assert)(target.url, "url is required");
  const freeFn = [];
  ...
  if (target.viewportScale) {
    ...
    (0, import_utils15.assert)(dpr > 0, `viewportScale must be greater than 0, but got ${dpr}`);
  }

...
// src/playground/server.ts
var import_utils15 = require("@midscene/core/utils");
...
var PlaygroundServer = class {
  constructor() {
    ...
    this.tmpDir = (0, import_utils15.getTmpDir)();
    setup();
  }
  ...
  async launch() {
    ...
    this.app.get("/context/:uuid", async (req, res) => {
      ...
      (0, import_utils16.assert)((0, import_node_fs3.existsSync)(contextFile), "Context not found");
    ...
    this.app.post(
      ...
      async (req, res) => {
        ...
        (0, import_utils16.assert)(context, "context is required");
    ...
    this.app.post(
      ...
      async (req, res) => {
        ...
        (0, import_utils16.assert)(context, "context is required");
        (0, import_utils16.assert)(type, "type is required");
        (0, import_utils16.assert)(prompt, "prompt is required");

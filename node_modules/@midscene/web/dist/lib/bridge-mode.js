...
var BridgeServer = class {
  ...
  async listen(timeout = 3e4) {
    return new Promise((resolve, reject) => {
      ...
      this.connectionTipTimer = timeout > 3e3 ? setTimeout(() => {
      ...
      this.io.on("connection", (socket) => {
        ...
        try {
          ...
          console.log(
            `Bridge connected, cli-side version v${"0.12.8"}, browser-side version v${clientVersion}`
          );
...
var getBridgePageInCliSide = () => {
  ...
  return new Proxy(page, {
    get(target, prop, receiver) {
      (0, import_utils13.assert)(typeof prop === "string", "prop must be a string");
      if (prop === "toJSON") {
        return () => {
          return {

...
import { assert as assert5, getDebug as getDebug2 } from "@midscene/shared/utils";
...
var PlaygroundServer = class {
  ...
  filePathForUuid(uuid2) {
    return join3(this.tmpDir, `${uuid2}.json`);
  }
  ...
  async launch() {
    ...
    this.app.get("/context/:uuid", async (req, res) => {
      ...
      assert6(existsSync3(contextFile), "Context not found");
    ...
    this.app.post(
      ...
      async (req, res) => {
        ...
        assert6(context, "context is required");
    ...
    this.app.post(
      ...
      async (req, res) => {
        ...
        assert6(context, "context is required");
        assert6(type, "type is required");
        assert6(prompt, "prompt is required");
